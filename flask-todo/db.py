...
def function(#parameters if any):
    try:
        #Setup connection
        conn=mc.connect(host="localhost",username="root",password="your_mysql_password",database="to-do")
        cursor=conn.cursor()
...
def add_user(user_details):
    ...
    try:
        conn=mc.connect(host="localhost",username="root",password="your_mysql_password",database="to_do")
        cursor=conn.cursor()
        conn.start_transaction()
